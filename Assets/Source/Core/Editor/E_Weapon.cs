...
public class E_Weapon : Editor
{
    ...
    private readonly GUIContent _damage =        new GUIContent("Damage", "Amount of damage the weapon does.");
    ...
    private void ShowStats()
    {
        ...
        _x.ProjectileSpawnPoint = EditorGUILayout.ObjectField("Spawn Pointt", _x.ProjectileSpawnPoint, typeof(GameObject), true) as GameObject;
        ...
        if (!_melee)
        {
            ...
            _x.Stats.Damage = EditorGUILayout.IntField(_damage, _x.Stats.Damage);
